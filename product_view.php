      ...
      <div class="left1">
        <div class="fl">
          ...
          <div class="TabTitle2">
            <ul class="expmenu">
              <li>
                <div class="header"><a href="show.php" title="">产品展示</a></div>
              </li>
            </ul>
          </div>
        </div>
...
?>
      ...
      <div class="right1">
        <div class="position">您当前位置：<a href="index.php" title="">网站首页</a> > <a href="show.php" title="">产品展示</a> > <?php echo $rzt['name']; ?></div>
        <div class="news">

...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <!-- Show a notification if the user has disabled javascript -->
     ...
     <form action="../bll/case_update.php" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
    <!-- Page Head -->
    <h2>后台管理系统--解决方案</h2>
	<br></br>
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <table style="border:5px;border-color:black;">
			...
			<tr>
				...
				<th></th>
                        ...
                        while($rzt = mysql_fetch_assoc($qry)){
                            ?>
			<tr>
				<td style="text-align:right;width:100px;">方案标题<input type="hidden" value="<?php echo $rzt['id']; ?>" name="id" /></td>
			...
			<tr>
				<td style="text-align:right;width:150px;">方案状态</td>
			...
			<tr>
				<td style="text-align:left;vertical-align:top;">方案内容:</td>
			</tr>
			<tr>

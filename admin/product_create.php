<?php 
    ...
    if(isset($_SESSION['username']))
    {
        ...
        // $sql = "select * from product where create_date>='".$time."' order by create_date desc ";
        // $qry = mysql_query($sql);
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <!-- Show a notification if the user has disabled javascript -->
     ...
     <form action="../bll/product_insert.php" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
    <!-- Page Head -->
    <h2>后台管理系统--产品管理</h2>
	<br></br>
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
		...
		<ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">新增产品</a></li>
        </ul>
        <div class="clear"></div>
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <table style="border:5px;border-color:black;">
			...
			<tr>
				<td style="text-align:right;width:100px;">产品名称</td>
			...
			<tr>
				...
				<td style="text-align:right;width:150px;">产品类型</td>
				<td style="text-align:left;width:500px;">
					<select name="type" width="500px" >
						<option>计算机视觉产品</option>
						<option>信号采集产品</option>
						<option>信号处理产品</option>
						<option>高速交换系统</option>
						<option>其他</option>
					</select>
				</td>
			</tr>
			...
			<tr>
				<td style="text-align:right;vertical-align:top;">产品介绍</td>
			</tr>
			<tr>
				<td colspan="4" style="text-align:left;width:800px">    
				<!-- 加载编辑器的容器 -->

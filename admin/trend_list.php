<?php 
    ...
    if(isset($_SESSION['username']))
    {
        ...
        $sql = "select * from news where type='dt' order by create_date desc ";
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
		...
		<ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">行业动态</a></li>
        </ul>
        <div class="clear"></div>
			  <a href="trend_create.php" target="_blank"><img src="../images/create.jpg" width="12px">新增动态</a>
      </div>
        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td></td>
                <td><?php echo $rzt['title']; ?></td>
                <td><?php echo $rzt['status']; ?></td>
                
                <td>
                <a href="trend_edit.php?id=<?php echo $rzt['id']; ?>" target="_blank" title="动态内容">
                ...
                <td>
                  <!-- Icons -->
                  <a href="trend_edit.php?id=<?php echo $rzt['id']; ?>" title="编辑"><img src="../public/Images/admin/icons/pencil.png" alt="编辑" /></a>
                  <a href="../bll/trend_delete.php?id=<?php echo $rzt['id']; ?>" title="删除"><img src="../public/Images/admin/icons/cross.png" alt="删除" /></a> 
                </td>
              </tr>  
                        <?php
                        }

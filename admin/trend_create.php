<?php 
    ...
    if(isset($_SESSION['username']))
    {
        ...
        $sql = "select * from news where create_date>='".$time."' order by create_date desc ";
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <!-- Show a notification if the user has disabled javascript -->
     ...
     <form action="../bll/trend_insert.php" method="post" accept-charset="UTF-8">
    <!-- Page Head -->
    <h2>后台管理系统--行业动态</h2>
	<br></br>
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <table style="border:5px;border-color:black;">
			...
			<tr>
				<td style="text-align:right;width:100px;">动态标题</td>
				<td cols="3" style="text-align:left;width:500px;"><input type="text" name="title" class="title" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="text-align:right;width:100px;">动态状态</td>
			...
			<tr>
				<td style="text-align:right;vertical-align:top;">动态内容</td>

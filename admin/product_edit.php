...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <!-- Show a notification if the user has disabled javascript -->
     ...
     <form action="../bll/product_update.php" method="post" enctype='multipart/form-data' accept-charset="UTF-8">
    <!-- Page Head -->
    <h2>后台管理系统--产品管理</h2>
	<br></br>
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
		...
		<ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">产品维护</a></li>
        </ul>
        <div class="clear"></div>
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <table style="border:5px;border-color:black;">
			...
			<tr>
				...
				<th></th>
                        ...
                        while($rzt = mysql_fetch_assoc($qry)){
                            ?>
			<tr>
				<td style="text-align:right;width:100px;">产品名称<input type="hidden" value="<?php echo $rzt['id']; ?>" name="id" /></td>
			...
			<td>首页图片预览：</td>
			<td><img src="../<?php echo $rzt['picture_url']; ?>" width="128px"></td>
			</tr>
			<tr>
				<td style="text-align:left;vertical-align:top;">产品简介:</td>
			</tr>
			<tr>

<?php 
    ...
    if(isset($_SESSION['username']))
    {
        ...
        $sql = "select * from news where type='xw' order by create_date desc ";
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
		...
		<ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">新闻管理</a></li>
        </ul>
        <div class="clear"></div>
			  <a href="news_create.php" target="_blank"><img src="../images/create.jpg" width="12px">新增新闻</a>
      </div>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                <a href="news_edit.php?id=<?php echo $rzt['id']; ?>" target="_blank" title="新闻内容">
                ...
                <td>
                  <!-- Icons -->
                  <a href="news_edit.php?id=<?php echo $rzt['id']; ?>" title="编辑"><img src="../public/Images/admin/icons/pencil.png" alt="编辑" /></a>
                  <a href="../bll/news_delete.php?id=<?php echo $rzt['id']; ?>" title="删除"><img src="../public/Images/admin/icons/cross.png" alt="删除" /></a> 
                </td>
              </tr>  
                        <?php
                        }

...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <!-- Show a notification if the user has disabled javascript -->
     ...
     <form action="../bll/news_insert.php" method="post" accept-charset="UTF-8">
    <!-- Page Head -->
    <h2>后台管理系统--新闻管理</h2>
	<br></br>
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <table style="border:5px;border-color:black;">
			...
			<tr>
				<td style="text-align:right;width:100px;">新闻标题</td>
			...
			<tr>
				<td style="text-align:right;width:100px;">新闻状态</td>
			...
			<tr>
				<td style="text-align:right;vertical-align:top;">新闻内容</td>

<?php 
    ...
    if(isset($_SESSION['username']))
    {
        ...
        $sql = "select * from recruit where 1=1 order by create_date desc ";
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
		...
		<ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">招聘管理</a></li>
        </ul>
        <div class="clear"></div>
			  <a href="recruit_create.php" target="_blank"><img src="../images/create.jpg" width="12px">新增招聘信息</a>
      </div>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                <?php echo $rzt['create_user'] ?>        
                </td>
                
                <td><?php echo $rzt['create_date']; ?></td>
                <td>
                  <!-- Icons -->
                  <a href="recruit_edit.php?id=<?php echo $rzt['id']; ?>" title="编辑"><img src="../public/Images/admin/icons/pencil.png" alt="编辑" /></a>
                  <a href="../bll/recruit_delete.php?id=<?php echo $rzt['id']; ?>" title="删除"><img src="../public/Images/admin/icons/cross.png" alt="删除" /></a> 
                </td>
              </tr>  
                        <?php
                        }

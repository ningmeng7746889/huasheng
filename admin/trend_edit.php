      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <table style="border:5px;border-color:black;">
			...
			<tr>
				...
				<th></th>
                        ...
                        while($rzt = mysql_fetch_assoc($qry)){
                            ?>
			<tr>
				<td style="text-align:right;width:100px;">动态标题<input type="hidden" value="<?php echo $rzt['id']; ?>" name="id" /></td>
			...
			<tr>
				<td style="text-align:right;width:150px;">动态状态</td>
			...
			<tr>
				<td style="text-align:left;vertical-align:top;">动态内容:</td>
			</tr>
			<tr>

<?php
	...
	{ 
		$sql = "update product set name='$name',create_date='$date',contents='$contents',status='$status',type='$type' where id='$id' ";
	...
	} else
	{
		...
		$sql = "update product set name='$name',create_date='$date',contents='$contents',status='$status',type='$type',picture_url='$url' where id='$id' ";

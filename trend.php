<?php 
    ...
    $sql = "select * from news where status='发布' and type='dt' order by create_date desc ";
...
<div class="all">
  <div class="content">
    <div class="main1">
      <div class="left1">
        <div class="fl">
          <div class="bt2">行业动态<span>TREND</span></div>
          <div class="TabTitle2">
            <ul class="expmenu">
              <li>
...
?>
      ...
      <div class="right1">
        <div class="position">您当前位置：<a href="index.php" title="">网站首页</a> > <a href="news.php" title="">行业动态</a></div>
